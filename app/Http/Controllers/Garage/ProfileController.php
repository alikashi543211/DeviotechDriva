...
class ProfileController extends Controller
{
    ...
    public function profile(Request $req)
    {
        ...
        return view("garage.profile.profile",get_defined_vars());
    }
    public function redirection(Request $req)
    {
        return redirect()->route('garage.profile.contact_info');
    }
    ...
    public function saveProfile(Request $req)
    {
        $messages = [
            ...
            'uk_postcode.required' => 'Enter post code',
    	...
    	return redirect()->route('garage.profile.redirection',['msg'=>'Your contact information has been saved']);

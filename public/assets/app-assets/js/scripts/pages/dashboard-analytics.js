...
$(window).on("load", function() {
    ...
    var gainedChart = new ApexCharts(
        document.querySelector("#subscribe-gain-chart-function"),
        gainedChartoptions
    );
    ...
    var orderChart = new ApexCharts(
        document.querySelector("#orders-received-chart-function"),
        orderChartoptions
    );
    ...
    var sessionChart = new ApexCharts(
        document.querySelector("#avg-session-chart-function"),
        sessionChartoptions
    );
    ...
    var supportChart = new ApexCharts(
        document.querySelector("#support-tracker-chart-function"),
        supportChartoptions
    );

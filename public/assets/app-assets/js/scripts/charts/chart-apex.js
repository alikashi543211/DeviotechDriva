...
$(document).ready(function() {
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#discount-overview-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#profile-views-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#completed-bookings-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#followers-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#district-ads-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#city-ads-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChartOptions = {
        ...
        title: {
            text: 'Total Consumer Registered',
            align: 'left'
        },
        grid: {
            row: {
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#consumer-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#garage-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var lineChart = new ApexCharts(
        document.querySelector("#ads-chart"),
        lineChartOptions
    );
    lineChart.render();
    ...
    var barChart = new ApexCharts(
        document.querySelector("#cities-chart"),
        barChartOptions
    );
    barChart.render();

...
$(window).on("load", function(){
    ...
    var visitsChart = echarts.init(document.getElementById('visits-chart'));
    var consumerChart = echarts.init(document.getElementById('consumer-chart'));
    var garageChart = echarts.init(document.getElementById('garage-chart'));
    var adsChart = echarts.init(document.getElementById('ads-chart'));
    ...
    visitsChart.setOption(lineChartoption);
    consumerChart.setOption(lineChartoption);
    garageChart.setOption(lineChartoption);
    adsChart.setOption(lineChartoption);

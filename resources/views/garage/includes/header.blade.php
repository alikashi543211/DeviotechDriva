                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-primary badge-up">{{$unread_notifications_counter}}</span></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                ...
                                <a class="d-flex justify-content-between" href="javascript:void(0)">
                                    <div class="media d-flex align-items-start">
                                        ...
                                        <div class="media-body">
                                            <h6 class="primary media-heading">You have new notification!</h6><small class="notification-text"> {{$data->data['msg']}}</small>
                                        </div><small>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item p-1 text-center" href="{{route('garage.notifications')}}">View all notifications</a></li>
                        </ul>
                    </li>
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                    <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"> Hi, {{getFirstName(auth()->user()->name)}} </span><span class="user-status">{{ $available_status}}</span></div>
                                    <span>

                                        @if(isset(garage()->picture))
                                        <img class="round" src="{{asset(garage()->picture)}}" alt="avatar" height="40" width="40">
                                        @else
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            {{-- <a class="dropdown-item" href="#"><i class="feather icon-message-square"></i> {{ $available_status}}</a> --}}

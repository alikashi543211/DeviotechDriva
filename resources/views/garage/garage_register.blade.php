...
<head>
    ...
    <title>Garage account registration – Driva</title>
                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">Sign up to your garage account</h4>
                                            </div>
                                        </div>
                                        <p class="px-2">Manage your bookings and advertise your motor services across the UK</p>
                                        <div class="card-content pb-0">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('garage.register') }}" method="post" class="validate-form">
                                                    @csrf
                                                    <fieldset class="form-label-group form-group position-relative">
                                                        <input type="text" id="garage-name" class="form-control @error('garage_name') is-invalid @enderror" name="garage_name" value="{{ old('garage_name') }}" autocomplete="garage_name" autofocus>
                                                        <span class="invalid-feedback" role="alert">
                                                            @error('garage_name')
                                                                <strong>{{ $message }}</strong>
                                                            @enderror
                                                        </span>
                                                        <label for="user-name" class="label-size">Garage Name</label>
                                                    </fieldset>
                                                    ...
                                                    <fieldset class="form-label-group position-relative">
                                                        ...
                                                        <input type="password"  class="form-control @error('password') is-invalid @enderror" id="user-password" name="password" autocomplete="current-password">
                                                        <span class="invalid-feedback" role="alert">
                                                            @error('password')
                                                                <strong>{{ $message }}</strong>
                                                            @enderror
...
<script>
    ...
    $(".validate-form").validate({
        ...
        messages: {
			garage_name: {
				required: 'Enter your garage name',
                minlength: 'Enter your garage name',
            },
            first_name: {

                            ...
                            <tr>
                              <td align="center">
                                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                    <td> <a style="text-transform:none;" href="{{route('garage.settings.invite_link',['user'=>base64_encode($user['email']),'name'=>$user['name'],'invited_by'=>$user['invited_by']])}}" target="_blank">Accept invitation</a> </td>
                                    </tr>

                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">Your email has been verified</h4>
                                            </div>
                                        </div>
                                        <p class="px-2 mb-5">Thank you for verifying your email. Your new Driva account has been activated and you can now proceed to <a href="{{ route('login.login') }}">login</a></p>

        ...
        <div class="col-12">
            <div class="tabs-section">
                <ul>
                    ...
                    <li><a href="{{ route('garage.advertising.promo.pricing') }}?p={{ base64_encode($plan) }}">Select Pricing</a></li>
                    <li class="active"><a href="{{ route('garage.advertising.promo.overview') }}">Overview</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-12 text-center" style="padding-bottom: 50px;">
        {{-- <a href="#" class="btn btn-light waves-effect waves-light dec-btn">DECLINE</a> --}}
        <form action="{{ route('garage.advertising.promo.submit') }}" method="POST">
            @csrf
            <input type="hidden" name="plan" value="{{ base64_encode($plan) }}">
            <input type="hidden" name="days" value="{{ base64_encode($days) }}">
            <input type="hidden" name="amount" value="{{ base64_encode($amount) }}">
            <button type="submit" class="btn btn-save btn-primary waves-effect waves-light">Submit</button>
        </form>
    </div>
</div>

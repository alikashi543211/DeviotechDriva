                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <div class="dropdown-header m-0 p-2">
                                    <h3 class="white">{{ auth()->user()->unreadNotifications->count() }} New</h3><span class="notification-title">Notifications</span>
                                </div>
                            </li>
                                ...
                                <a class="d-flex justify-content-between" href="javascript:void(0)">
                                    <div class="media d-flex align-items-start">
                                        ...
                                        <div class="media-body">
                                            <h6 class="primary media-heading">{{ $notification->data['data'] }}</h6>
                                        </div>
                                        <small>
                    ...
                    @if(Auth::user())
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                @if(Auth::user())
                                    <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"> {{ getFirstName(Auth::user()->name) }} </span><span class="user-status">{{ __('Available') }}</span></div>
                                    <span>
                                        @if(!isset(auth()->user()->picture))
                                        <img class="round" src="{{asset('images/user.png')}}" alt="avatar" height="40" width="40">
                                        @else
                                        <img class="round" src="{{asset(auth()->user()->picture)}}" alt="avatar" height="40" width="40">
                                        @endif
                                    </span>
                                @endif
                            </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{route('admin.settings')}}"><i class="feather icon-user"></i> Edit Profile</a>
                            <a class="dropdown-item" href="{{ route('admin.support.enquiries') }}"><i class="feather icon-mail"></i> Enquiries</a>
                            <a class="dropdown-item" href="{{ route('admin.support.reports') }}"><i class="feather icon-check-square"></i> Reports</a>

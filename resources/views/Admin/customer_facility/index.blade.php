...
@section('title', 'Customer Facilities')
@section('content')
                                            ...
                                            <table class="table zero-configuration table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a href="{{ route('admin.customerFacilities.edit', $item->id) }}" class="btn btn-sm btn-info">Edit</a>
                                                            <a href="{{ route('admin.customerFacilities.delete', $item->id) }}" class="btn btn-sm btn-danger del-btn">Delete</a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>

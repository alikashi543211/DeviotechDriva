                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        @else
                                        We have sent a reset link to {{Session::get('driva_user_email')}} Please click on the link in your email to reset your account.</p>
                                        @endif
                                        <div class="card-content pb-2">
                                            <div class="card-body pt-1">
                                            <p class="px-2">Didn't receive the email? <a href="{{ route('login.resend_reset_password',base64_encode($email))}}">Resend</a></p>
                                                <div class="mt-2">

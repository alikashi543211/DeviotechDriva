                    ...
                    <tr>
                      ...
                      <div class="header">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <div>
                            <h1 align="center" style="font-size:24px;font-weight:bold;margin-top: 30px;text-transform:none;font-family:arial;">Reset your password</h1>
                          </div>
                        <p style="text-align:justify;color:grey;font-size:16px;margin-bottom: 30px;">Reset my password.</p>
                            ...
                            <tr>
                              <td align="center">
                                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a style="text-transform:none;" href="{{route('login.reset_password',base64_encode($email))}}" target="_blank">Reset my password</a> </td>
                                    </tr>
                        ...
                        <div align="center"><p style="color:#5c5cf1;font-size:15px;font-weight:bold;word-break: break-all;">{{route('login.reset_password',['email'=>base64_encode($email)])}}</p></div>
                      </td>
                    </tr>
                  </table>
                </td>

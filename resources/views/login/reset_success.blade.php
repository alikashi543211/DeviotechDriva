...
<head>
    ...
    <title>Reset success – Driva</title>
                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">You have changed your password successfully</h4>
                                            </div>
                                        </div>
                                        <p class="px-2">Click the below button to login your account.</p>
                                                ...
                                                <div class="mt-2">
                                                    <div class="row text-center">
                                                        <div class="col-12">
                                                            ...
                                                            <a href="{{ route('login.login') }}" class="btn btn-danger btn-block">Login</a>

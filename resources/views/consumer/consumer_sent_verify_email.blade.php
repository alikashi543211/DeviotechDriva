                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">We've sent verification link to your email</h4>
                                            </div>
                                        </div>
                                        <p class="px-2">Click the link in the email to verify your consumer account</p>
                                        <div class="card-content pb-2">
                                            ...
                                            <p class="px-2">Didn't receive the email?</p>
                                                ...
                                                <div class="row text-center">
                                                    ...
                                                    <a href="{{ route('consumer.verify_email_send',['email'=>$request->email]) }}" class="btn btn-danger btn-block">Resend verify link</a>

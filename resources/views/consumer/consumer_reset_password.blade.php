                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Enter your new password and confirm password to reset your account details.</p>
                                        <div class="card-content pb-2">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('consumer.reset_password') }}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="email" value="{{base64_decode($request->email)}}" >
                                                    <fieldset class="form-label-group position-relative">
                                                        <input type="password" rel="txtTooltip" title="Your password must contain at least Six characters( One upper case, One Lower case, One digit )" data-toggle="tooltip" data-placement="bottom" id="user-password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                                        @error('password')
                                                        ...
                                                        <label for="user-password" class="label-size">Password <i class="fa fa-info-circle label-size"></i></label>
                                                    </fieldset>

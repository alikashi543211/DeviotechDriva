                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Enter your email address and we will send you a link to reset your password.</p>
                                        <div class="card-content pb-2">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('consumer.forgot_password') }}" method="post">
                                                    @csrf
                                                ...
                                                <div class="row text-center">
                                                    <div class="col-6">
                                                    <a href="{{ route('consumer.login') }}" class="btn btn-outline-danger btn-block">Back to login</a>
                                                    </div>

<script>
    ...
    var count_class=".{{$req->count}}";
    var circle_title="{{$req->circle_title}}";
    $(".new-bookings-count-info").html("{{$total_bookings_count}}");
    $(".active-bookings-count-info").html("{{$active_bookings_count}}");
    $(".complete-bookings-count-info").html("{{$complete_bookings_count}}");
    $(count_class).html("{{$bookings_count}}")
    var $primary = '#7367F0';
            var $danger = '#EA5455';
            var $warning = '#FF9F43';
            var $info = '#0DCCE1';

										...
										<li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-primary badge-up">{{$unread_notifications_counter}}</span></a>
												...
												<li class="dropdown dropdown-user nav-item">
														<a class="dropdown-toggle nav-link dropdown-user-link online_parent" href="javascript: void(0);" data-toggle="dropdown">
															<div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"> Hi, {{getFirstName(Auth::user()->name)}} </span><span class="user-status">{{ucfirst($available_status) }}</span></div>
														<span>
												...
												<a class="dropdown-item available-status online_parent" href="javascript:void(0);" data-value="{{$available_status}}"><i class="feather icon-message-square"></i><i class="fa fa-circle @if($available_status=="available") offline_icon_on_msg @else text-secondary text-success online_icon_on_msg @endif" aria-hidden="true"></i>@if($available_status=="available") Away @else Available @endif</a>

...
@section('css')
    ...
    <style>
        ...
        {
            background-color:#29c770 !important;
        }
    </style>
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-md-3 mb-2 mb-md-0">
                <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                    <li class="nav-item">
                        <a href="{{ route('consumer.settings.account') }}" class="nik nav-link d-flex py-75 {{ (request()->is('consumer/settings/account-profile')) ? 'active' : '' }}" style="border-radius: 0; color:#000;" >
                            <i class="feather icon-user mr-50 font-medium-3"></i>
                            General
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('consumer.settings.authentication') }}" class="nik  nav-link d-flex py-75 {{ (request()->is('consumer/settings/authentication')) ? 'active' : '' }}" style="border-radius: 0; color:#000;">

                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">Account Login</h4>
                                            </div>
                                        </div>
                                        <p class="px-2">Welcome back. Please login to your account</p>
                                        <div class="card-content pb-2">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('consumer.post.login') }}" method="post">
                                                    @csrf
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        <input type="password" id="user-password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="current-password">
                                                        @error('password')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-right"><a href="{{ route('consumer.forgot_password') }}" class="card-link">Forgot password?</a></div>
                                                    </div>
                                                ...
                                                <div class="row text-center">
                                                        <div class="col-12">
                                                            <small>Don’t have an account? <a href="{{ route('consumer.register') }}">Register</a></small>
                                                        </div>
                                                </div>
                                             </div>
                                            </div>

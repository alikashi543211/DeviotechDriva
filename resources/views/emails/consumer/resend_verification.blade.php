...
<p style="font-family: sans-serif;text-align:center;color:grey;font-size:16px;margin-bottom: 30px;">Here is your resent verification email link. Activate your account by verifying your email address.</p>
        ...
        <tr>
            <td style="font-family: sans-serif;font-size: 14px;vertical-align: top;background-color: #ea5455;border-radius: 5px;text-align: center;" align="center">
                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0" style="border-collapse: separate;mso-table-lspace: 0pt;mso-table-rspace: 0pt;min-width: 100%;width: 100%;">
                    <tbody>
                        <tr>
                            <td style="font-family: sans-serif;font-size: 14px;vertical-align: top;background-color: #ea5455;border-radius: 5px;text-align: center;"> <a style="text-decoration: none;box-sizing: border-box;text-transform: capitalize;cursor: pointer;font-size: 14px;font-weight: bold;margin: 0;padding: 12px 25px;display: inline-block; border: solid 1px #ea5455;border-color: #ea5455;border-radius: 5px;color: #ffffff;" href="{{route('consumer.verify_email',base64_encode($user['email']))}}" target="_blank">Verify my email</a> </td>
                        </tr>
                    </tbody>
                </table>
            </td>
...
<div align="center"><p style="font-family: sans-serif;color:#5c5cf1;font-size:15px;font-weight:bold;word-break: break-all;">{{route('consumer.verify_email',base64_encode($user['email']))}}</p></div>
@endsection

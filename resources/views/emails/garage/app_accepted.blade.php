...
@section('content')
<div>
    <h1 align="center" style="color: #06090f;font-size:24px;font-weight:bold;margin-top: 30px;text-transform:none;font-family: sans-serif;line-height: 1.4;margin-bottom: 30px;">Congrats! Your account has been approved</h1>
</div>
<p style="font-family: sans-serif;text-align:center;color:grey;font-size:16px;margin-bottom: 30px;">We have accepted your garage account application.  </p>

<p style="font-family: sans-serif;text-align:center;color:grey;font-size:16px;margin-bottom: 30px;">We have now sent a verification code to your garage address which will be required to activate your account. Please <a href="javascript:void(0);">contact us</a> if you do not receive the code within five working days.  </p>

...
@section('content')
<div>
    <h1 align="center" style="color: #06090f;font-size:24px;font-weight:bold;margin-top: 30px;text-transform:none;font-family: sans-serif;line-height: 1.4;margin-bottom: 30px;">Booking request approved</h1>
</div>
<p style="font-family: sans-serif;text-align:center;color:grey;font-size:16px;margin-bottom: 30px;">You have approved of a booking request. Please await confirmation from {{ $consumer_name }}. Login to your account to view more.</p>

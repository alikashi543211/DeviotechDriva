...
@section('content')
<div>
    <h1 align="center" style="color: #06090f;font-size:24px;font-weight:bold;margin-top: 30px;text-transform:none;font-family: sans-serif;line-height: 1.4;margin-bottom: 30px;">Unfortunately, your application has been declined</h1>
</div>

<p style="font-family: sans-serif;text-align:center;color:grey;font-size:16px;margin-bottom: 30px;">We believe that there is an issue with your application. Please go over the information again. If you believe that there was a mistake, please <a href="javascript:void(0);">contact us</a>.</p>
